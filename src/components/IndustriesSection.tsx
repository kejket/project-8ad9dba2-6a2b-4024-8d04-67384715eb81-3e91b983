      ...
      <div className="container-narrow section-padding">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {industries.map((industry) => (
            <div
              key={industry.name}
              className="group flex flex-col p-6 rounded-xl border border-border bg-card hover:border-industrial/30 hover:shadow-card transition-all duration-300"
            >
              ...
              <Link 
                to="/industry" 
                className="inline-flex items-center gap-1.5 text-sm font-medium text-industrial hover:text-industrial/80 transition-colors"
              >
                산업별 적용 사례 보기
                <ArrowRight size={14} />
              </Link>
